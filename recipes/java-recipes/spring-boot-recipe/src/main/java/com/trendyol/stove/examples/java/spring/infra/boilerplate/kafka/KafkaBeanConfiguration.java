...
public class KafkaBeanConfiguration {
  ...
  public Properties consumerProperties(KafkaConfiguration kafkaConfiguration) {
    ...
    properties.put(
        ...
        (int) Duration.ofSeconds(kafkaConfiguration.getRequestTimeoutSeconds()).toMillis());
    properties.put(
        ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG,
        (int) Duration.ofSeconds(kafkaConfiguration.getHeartbeatIntervalSeconds()).toMillis());
    properties.put(
