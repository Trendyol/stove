...
public class KafkaBeanConfiguration {
    ...
    public Properties consumerProperties(KafkaConfiguration kafkaConfiguration) {
        ...
        properties.put(ConsumerConfig.REQUEST_TIMEOUT_MS_CONFIG, (int)
                Duration.ofSeconds(kafkaConfiguration.getRequestTimeoutSeconds())
                        .toMillis());
        properties.put(ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG, (int)
                Duration.ofSeconds(kafkaConfiguration.getHeartbeatIntervalSeconds())
                        .toMillis());
        properties.put(ConsumerConfig.SESSION_TIMEOUT_MS_CONFIG, (int)
                Duration.ofSeconds(kafkaConfiguration.getSessionTimeoutSeconds())
                        .toMillis());
        properties.put(
                ConsumerConfig.ALLOW_AUTO_CREATE_TOPICS_CONFIG,
                kafkaConfiguration.isAutoCreateTopics());
        properties.put(
        ...
        properties.put(
                ...
                kafkaConfiguration.flattenInterceptorClasses());
