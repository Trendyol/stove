...
class WireMockOperationsTest : FunSpec({
        ...
        TestSystem.validate {
            wiremock {
                mockPostConfigure("/$url") { req, _ ->
                    req.withRequestBody(equalTo("request2"))
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("response2").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
                mockPostConfigure("/$url") { req, _ ->
                    req.withRequestBody(equalTo("request1"))
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("response1").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
    ...
    test("Wiremock mockGetConfigure should mock urls with urlEqualTo(url) pattern in default") {
            ...
            wiremock {
                mockGetConfigure("/suppliers/1?active=true") { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("Supplier1Response").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
                mockGetConfigure("/suppliers/2?active=false") { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("Supplier2Response").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
        ...
        withContext(Dispatchers.IO) {
            ...
            val reqBuilder2 = HttpRequest.newBuilder(uri2)
                .header("Content-Type", "application/json")
    ...
    test("Wiremock mockGetConfigure should accept overridden urlMatcher") {
        ...
        withContext(Dispatchers.IO) {
            ...
            val request1 = HttpRequest.newBuilder(uri1)
                .header("Content-Type", "application/json")
                .GET()
                .build()
            val response1 = client.send(request1, BodyHandlers.ofString())
            ...
            active = false
            val uri2 = URI.create("http://localhost:9098/suppliers/$id?active=$active")
            val request2 = HttpRequest.newBuilder(uri2)
                .header("Content-Type", "application/json")
                .GET()
                .build()
            val response2 = client.send(request2, BodyHandlers.ofString())
            ...
            val request3 = HttpRequest.newBuilder(uri3)
                .header("Content-Type", "application/json")
                .GET()
                .build()
            ...
            wiremock {
                mockPutConfigure("/resources/1") { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("PutResource1").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
            ...
            wiremock {
                mockPutConfigure("/resources/1", { urlPathMatching("/resources/.*") }) { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("PutResourceMatched").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
            ...
            wiremock {
                mockPatchConfigure("/resources/1") { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("PatchResource1").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
            ...
            wiremock {
                mockPatchConfigure("/resources/1", { (urlPathMatching("/resources/.*")) }) { req, _ ->
                    req
                        .withHeader("Content-Type", ContainsPattern("application/json"))
                        .willReturn(
                            aResponse().withBody("PatchResourceMatched").withStatus(200)
                                .withHeader("Content-Type", "application/json; charset=UTF-8")
                        )
                }
            }
