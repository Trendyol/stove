...
/**
 * Base interface for all systems that can be plugged into the [TestSystem].
 *
 ...
 * ): TestSystem = testSystem.getOrRegister(
 *     MyCustomSystem(testSystem, configure())
 * ).let { testSystem }
 *
 * // Validation DSL function
 * suspend fun ValidationDsl.myCustom(
 *     block: suspend MyCustomSystem.() -> Unit
 * ) = block(testSystem.getOrNone<MyCustomSystem>().getOrElse {
