...
class TestScopeTest :
  FunSpec({
    ...
    test("trace id is extracted from a well-formed traceparent only") {
      ...
      mapOf("traceparent" to "00-${"g".repeat(32)}-6c1e47ceae684b55-01").traceparentTraceId().shouldBeNull()
      mapOf("traceparent" to "00-29326663e1ca49e89820727aa7955f2b").traceparentTraceId().shouldBeNull()
      mapOf("traceparent" to "00-29326663e1ca49e89820727aa7955f2b-${"0".repeat(16)}-01")
        .traceparentTraceId()
        .shouldBeNull()
      mapOf("traceparent" to "00-29326663e1ca49e89820727aa7955f2b-6c1e47ceae684b5g-01")
        .traceparentTraceId()
        .shouldBeNull()
      mapOf("traceparent" to "00-29326663e1ca49e89820727aa7955f2b-6c1e47ceae684b55-0g")
        .traceparentTraceId()
        .shouldBeNull()
      mapOf("traceparent" to "ff-29326663e1ca49e89820727aa7955f2b-6c1e47ceae684b55-01")
        .traceparentTraceId()
        .shouldBeNull()
