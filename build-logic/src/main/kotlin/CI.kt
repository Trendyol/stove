...
val Project.hasSigningKey: Boolean
  get() = rootProject.findProperty("signing.keyId") != null ||
...
object CI {
  ...
  private val Project.snapshotBase: String
    get() = findProperty("snapshot").toString()

  private val Project.releaseVersion: String
    get() = findProperty("version").toString()
  ...
  fun version(project: Project): String = when {
    ...
    else -> project.findProperty("version").toString()
  }
}
