...
@EnableKafka
@EnableConfigurationProperties(KafkaTestSpringBotApplicationForStringSerde.KafkaTestSpringBotApplicationConfiguration::class)
  ...
  beforeSpec {
    TestSystem()
      .with {
        kafka {
          KafkaSystemOptions(
            serdeForPublish = StoveSerde.jackson.anyJsonStringSerde(),
