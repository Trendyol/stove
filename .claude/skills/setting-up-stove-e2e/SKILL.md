---
name: setting-up-stove-e2e
description: Sets up a complete end-to-end testing suite using the Stove framework. Configures test-e2e source set, Gradle dependencies (BOM), Stove systems (HTTP, PostgreSQL, Kafka, WireMock, gRPC Mock, gRPC Client, Bridge), OpenTelemetry tracing, and the stove {} test DSL. Use when creating e2e tests, adding Stove to a project, configuring Stove systems, writing integration tests, or setting up tracing for Stove.
---
...
- [ ] Step 4: Create TestConfig (AbstractProjectConfig)
