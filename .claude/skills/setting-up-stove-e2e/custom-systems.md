...
Key interfaces:
- `PluggedSystem` — required
- `AfterRunAwareWithContext<ApplicationContext>` — receives Spring context after app starts
- `Reports` — contributes to failure reports via `snapshot()`
