...
**Dashboard**: Add `stove-dashboard` to your dependencies and install the CLI via Homebrew (`brew install Trendyol/trendyol-tap/stove`) or the shell script. See the [Dashboard documentation](../Components/18-dashboard.md).
