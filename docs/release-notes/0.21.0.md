...
- **Tracing**: See the <span data-rn="highlight" data-rn-color="#00968855" data-rn-duration="800">full execution trace</span> of your application when a test fails: every controller, database query, Kafka message, and HTTP call with timing and failure points
