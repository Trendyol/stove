...
2. Attach the OpenTelemetry agent in your build. Copy [`StoveTracingConfiguration.kt`](https://github.com/Trendyol/stove/blob/0.21.0/buildSrc/src/main/kotlin/com/trendyol/stove/gradle/StoveTracingConfiguration.kt) to your project's `buildSrc/src/main/kotlin/` directory, then add to your `build.gradle.kts`:
