...
<span class="dim">────────────────────────────────────────────────────</span></pre>
  ...
  <div class="story-step">
    <div>
      ...
      <p>If the local dashboard is running, the same execution shows up as a clickable timeline at <code>http://localhost:8086</code>. System snapshots, message payloads, DB rows, all queryable.</p>
...
<span class="dim">└────────────────────────────────────────────────┘</span></pre>
  ...
  <div class="story-step">
    ...
    <pre class="story-frame">$ curl localhost:8086/mcp/tools/stove_failure_detail \
